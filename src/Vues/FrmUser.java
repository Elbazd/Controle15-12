...
public class FrmUser extends javax.swing.JFrame {
    ...
    private void btnModifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModifierMouseClicked
        ...
        fm.ModifierEtatTicket(idEtat, idTicket);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        FonctionsMetier foncM = new FonctionsMetier();
       
        mdlTicket = new ModelTicket();    
        mdlTicket.loadDatas(foncM.GetAllTicketsByIdUser(leUser.getIdUser()));      
        tblTickets.setModel(mdlTicket);       
        for (Etat etat : foncM.GetAllEtats())
        {
